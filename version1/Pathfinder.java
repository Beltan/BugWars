...
public class Pathfinder {
    ...
    public void moveTo(Location target){
        ...
        if (prevTarget == null || target.distanceSquared(prevTarget) > 100 || manager.myLocation.isEqual(target) || (uc.canSenseLocation(target) && !manager.isObstructed(target))) {
            resetPathfinding();
        }
    ...
    public void moveToQueen(Location target){
        ...
        if (prevTargetQueen == null || target.distanceSquared(prevTargetQueen) > 100 || manager.myLocation.isEqual(target) || (uc.canSenseLocation(target) && !manager.isObstructed(target))) {
